...
- `promptkt` (maven multi-module project) - PromptKt: core API and AiModelProvider provider implementations.
  ...
  - `promptkt-provider-sample` - Sample AiModelProvider provider implementation.
