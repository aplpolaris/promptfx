...
/** Integration tests for [OpenAiSdkChat] — requires a valid OpenAI API key. */
class OpenAiSdkChatTest {

    private val client = OpenAiSdkChat(OpenAiSdkModelIndex.GPT4O_MINI, OpenAiSdkModelIndex.MODEL_SOURCE, OpenAiSdkClient.INSTANCE)
