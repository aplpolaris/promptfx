...
//    fun <S> mapvalue(function: (T) -> S) = AiTaskResult<S>(
...
//    fun <S> maplist(function: (List<T>?) -> S) = AiTaskResult<S>(
//        function(values),
//        errorMessage, error, modelId, duration, durationTotal, attempts
//    )
//
...
//     */
//    fun asPipelineResult(promptInfo: AiPromptInfo? = null, modelInfo: AiPromptModelInfo? = null): AiPipelineResult<T> {
...
//            }.asPipelineResult()
//        }
//        return AiPipelineResult(this, mapOf("result" to this))
//    }
//
//    companion object {
