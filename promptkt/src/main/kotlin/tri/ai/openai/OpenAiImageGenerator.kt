...
class OpenAiImageGenerator(override val modelId: String = OpenAiModels.IMAGE_DALLE2, val client: OpenAiClient = OpenAiClient.INSTANCE) :
    ImageGenerator {

    override fun toString() = modelId

    override suspend fun generateImage(text: String, size: ImageSize, prompt: String?): URL {
