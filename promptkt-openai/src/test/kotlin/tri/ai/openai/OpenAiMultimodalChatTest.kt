...
class OpenAiMultimodalChatTest {
    ...
    private val chat = OpenAiMultimodalChat(OpenAiModelIndex.GPT35_TURBO_ID, client = client)
    private val chatVision = OpenAiMultimodalChat("gpt-4.1-nano", client = client)
