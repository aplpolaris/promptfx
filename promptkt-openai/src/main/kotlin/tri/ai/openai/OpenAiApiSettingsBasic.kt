...
class OpenAiApiSettingsBasic : OpenAiApiSettings {
    ...
    private fun readApiKey(): String {
        ...
        return if (key.isNullOrBlank()) {
            ...
            info<OpenAiApiSettingsBasic>("No OpenAI API key found. Please create a file named $API_KEY_FILE in the root directory, or set an environment variable named $API_KEY_ENV.")
            ""
        } else
            key
    }
