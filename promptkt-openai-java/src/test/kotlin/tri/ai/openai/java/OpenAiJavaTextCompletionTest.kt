...
class OpenAiJavaTextCompletionTest {

    val client = OpenAiJavaTextCompletion(GPT_4O_MINI)
    ...
    fun testComplete() {
        runTest {
            ...
            println(res)
            assertTrue("monde" in res.firstValue.text!!.lowercase() || "bonjour" in res.firstValue.text!!.lowercase())
        }
    }
    ...
    fun testCompleteMultiple() {
        runTest {
            ...
            println(res)
            assertTrue(res.output!!.outputs.size >= 1)
        }
    }
