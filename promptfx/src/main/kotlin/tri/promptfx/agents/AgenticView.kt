...
class AgenticView : AiPlanTaskView("Agentic Workflow", "Describe a task and any necessary input to use multiple views within a common workflow.") {
    ...
    init {
        ...
        // Override the default output area to include agent log
        outputPane.clear()
        output {
            tabpane {
    ...
    override fun plan(): AiPlanner = aitask("agent") {
        // Clear the agent log at the start
        ...
        // set up task execution flow with UI collector
        ...
        // Collect events with UI collector instead of console logger
