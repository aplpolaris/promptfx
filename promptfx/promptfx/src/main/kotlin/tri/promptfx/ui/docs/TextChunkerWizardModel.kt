...
class TextChunkerWizardModel: ViewModel() {
    ...
    init {
        ...
        embeddingModel.set(controller.embeddingEngine.value?.model)
    }
    ...
    internal fun updatePreview() {
        ...
        previewChunks.setAll(useChunks.map { it.asTextChunkViewModel(doc, controller.embeddingEngine.value?.modelId, null) })
    }
