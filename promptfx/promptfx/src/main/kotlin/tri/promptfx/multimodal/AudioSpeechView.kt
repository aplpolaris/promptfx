...
class AudioSpeechApiPlugin : NavigableWorkspaceViewImpl<AudioSpeechView>("Multimodal", "Text-to-Speech", WorkspaceViewAffordance.INPUT_ONLY, AudioSpeechView::class)
