...
class WikipediaViewPlugin : NavigableWorkspaceViewImpl<WikipediaView>("Fun", "Wikipedia", type = WikipediaView::class)
...
class WikipediaView: AiPlanTaskView("Wikipedia", "Enter a question to ask Wikipedia.") {
    ...
    override fun plan() = WikipediaAiTaskPlanner(chatEngine, common, pageTitle, input.get()).plan()
