...
class ChatBackPlugin : NavigableWorkspaceViewImpl<ChatBackView>("Fun", "AI Chatting with Itself", type = ChatBackView::class)
...
class ChatBackView : AiPlanTaskView("AI Chatting with Itself", "Enter a starting prompt and/or add to conversation below.") {
    ...
    private suspend fun chatBack(): AiPromptTrace {
        ...
        return controller.chatEngine.value.asTextChat().chat(
