...
class StarshipView : Fragment("Starship") {
    ...
    val configs = StarshipConfig.readRuntimeYaml()
    val layout
        get() = configs.layout
    ...
    private fun runPipeline() {
        ...
        job = runAsync {
            ...
            runBlocking {
                StarshipPipelineExecutor(configs.question, configs.pipeline, controller.chatEngine.value.asTextChat(), stepDelayMs = if (isExplainerVisible) 3000 else 0,
